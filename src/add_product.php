...
<?php
	...
	incHeader('PHU | Add Product','','http://' . $_SERVER['SERVER_NAME'] .'/SPDX/phu/js/form.js');
...
<div class="row-fluid">
	<form style="margin-left:50px;" action="add_product_action.php" method="post" enctype="multipart/form-data" id="addForm" target="formSubFrame" onsubmit="formSubmit()" role="form">
